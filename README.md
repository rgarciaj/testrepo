# paypal OpenAPI Specification
[![Build Status](https://travis-ci.org/rgarciaj/testrepo.svg?branch=master)](https://travis-ci.org/rgarciaj/testrepo)
...
6. If you did everything correct, https://rgarciaj.github.io/testrepo/ will lead to your new docs
...
- Documentation(ReDoc): https://rgarciaj.github.io/testrepo/
- Look full spec:
    + JSON https://rgarciaj.github.io/testrepo/swagger.json
    + YAML https://rgarciaj.github.io/testrepo/swagger.yaml
- Preview spec version for branch `[branch]`: https://rgarciaj.github.io/testrepo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://rgarciaj.github.io/testrepo/ with url from the message: `Server started <url>`
